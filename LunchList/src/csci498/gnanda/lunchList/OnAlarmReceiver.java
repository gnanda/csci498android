...
public class OnAlarmReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context ctxt, Intent intent) {
		...
		if (useNotification) {
			...
			Notification note = new Notification(R.drawable.stat_notify_chat, ctxt.getString(R.string.time_for_lunch), System.currentTimeMillis());
			PendingIntent i = PendingIntent.getActivity(ctxt, 0, new Intent(ctxt, AlarmActivity.class), 0);
			
			note.setLatestEventInfo(ctxt, "LunchList", ctxt.getString(R.string.time_for_lunch_message), i);
			note.flags |= Notification.FLAG_AUTO_CANCEL;
			
			String sound = prefs.getString(AlarmActivity.ALARM_RINGTONE, null); 
